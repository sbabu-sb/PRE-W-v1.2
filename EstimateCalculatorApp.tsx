...
import { MetaData, Payer, Procedure, WorklistPatient } from './types';
...
const AppContent: React.FC<EstimateCalculatorAppProps> = ({ patientData, onMarkComplete, onOpenJourney }) => {
                      ...
                      <div className="flex items-center space-x-2">
                          {onOpenJourney && (
                                <button 
                                    ...
                                    className="flex items-center space-x-2 text-sm bg-purple-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-purple-700 transition"
...
const EstimateCalculatorApp: React.FC<EstimateCalculatorAppProps> = ({ patientData, onMarkComplete, onOpenJourney }) => {
  return (
    <EstimateProvider>
        <AppContent patientData={patientData} onMarkComplete={onMarkComplete} onOpenJourney={onOpenJourney} />
    </EstimateProvider>
  );
};
