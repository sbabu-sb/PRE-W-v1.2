...
const CaseHistoryPanel: React.FC<CaseHistoryPanelProps> = ({ isOpen, onClose, patient, history }) => {
  ...
  return (
    <DrawerPanel isOpen={isOpen} onClose={onClose} title={`History: ${patient?.id}`} subtitle={patient?.metaData.patient.name}>
      {history.length === 0 ? (
