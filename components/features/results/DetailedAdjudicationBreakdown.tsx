...
const DetailedAdjudicationBreakdown: React.FC<DetailedAdjudicationBreakdownProps> = ({ adjudicationChain }) => {
    ...
    const summaryTooltip = `<div class='text-left'><p class='font-bold mb-1'>Term Definitions:</p><ul class='list-disc list-inside text-xs space-y-1'><li><b>Payment:</b> Estimated amount this insurance plan will pay.</li><li><b>Patient Share:</b> The patient's cost-sharing (copay, deductible, etc.) for this plan.</li></ul></div>`;
